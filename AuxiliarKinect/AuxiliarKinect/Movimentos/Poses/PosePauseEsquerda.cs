...
{
    public class PosePauseEsquerda : Pose
    {
        public PosePauseEsquerda()
        {
            this.Nome = "PosePauseEsquerda";
            ...
            PosicaoValida(Microsoft.Kinect.Skeleton esqueletoUsuario)
        {
            ...
            Util.CalcularProdutoEscalar(quadrilEsquerdo,ombroEsquerdo, maoEsquerda);
